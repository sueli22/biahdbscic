    ...
    <tbody>
        @foreach($leaveTypes as $leaveType)
            <tr>
               ...
               <td>
  <div class="dropdown">
    <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="actionMenu{{ $leaveType->id }}" data-bs-toggle="dropdown" aria-expanded="false">
      &#x22EE; <!-- vertical ellipsis unicode character -->
    </button>
    <ul class="dropdown-menu" aria-labelledby="actionMenu{{ $leaveType->id }}">
      <li><a class="dropdown-item btn-edit" href="#" data-id="{{ $leaveType->id }}">ပြင်ဆင်ရန်</a></li>
      <li><a class="dropdown-item btn-delete" href="#" data-id="{{ $leaveType->id }}">ဖျက်ရန်</a></li>
    </ul>
  </div>
</td>
    ...
    <form id="createLeaveTypeForm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">ဖျက်ရန်</button>
